...
import { CostAnalysis } from './costAnalysisService';

export class ResultsPanel {
    public static show(context: vscode.ExtensionContext, resourceBlock: string, analysis: CostAnalysis) {
        const panel = vscode.window.createWebviewPanel(
            'codeguardAnalysis',
            '🤖 CodeGuard AI Cost Analysis',
    ...
    private static getWebviewContent(resourceBlock: string, analysis: CostAnalysis): string {
        return `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
