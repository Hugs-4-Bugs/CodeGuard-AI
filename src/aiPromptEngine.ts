...
export interface AIAnalysisRequest {
    ...
    analysisType: 'cost_optimization' | 'security' | 'best_practices';
}
...
export class AIPromptEngine {
     ...
     */
    public static generatePrompt(request: AIAnalysisRequest): string {
...
Your recommendations must be safe for production use.`;
    ...
    private static buildUserPrompt(context: TerraformContext): string {
    ...
    private static getNATGatewayPrompt(context: TerraformContext): string {
...
${this.getResponseFormat()}`;
    ...
    private static getDynamoDBPrompt(context: TerraformContext): string {
...
${this.getResponseFormat()}`;
    ...
    private static getLambdaPrompt(context: TerraformContext): string {
...
${this.getResponseFormat()}`;
    ...
    private static getEC2Prompt(context: TerraformContext): string {
...
${this.getResponseFormat()}`;
    ...
    private static getRDSPrompt(context: TerraformContext): string {
...
${this.getResponseFormat()}`;
    ...
    private static getGenericPrompt(context: TerraformContext): string {
...
Focus on realistic, production-safe recommendations.`;
    ...
    private static getResponseFormat(): string {
        return `{
  "summary": {
    "currentCost": {
      "min": <number>,
